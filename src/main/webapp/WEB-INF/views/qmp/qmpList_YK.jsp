...
<body>
	...
	<div align="center" id="searchPage">
		...
		<a href="rest/qmp/searchYoukong?pageNow=1" class='search_A'>首页</a>
		<c:choose>
			<c:when test="${page.pageNow - 1 > 0}">
				<a href="rest/qmp/searchYoukong?pageNow=${page.pageNow - 1}"
		...
		<c:choose>
			<c:when test="${page.totalPageCount==0}">
				<a href="rest/qmp/searchYoukong?pageNow=${page.pageNow}"
		...
		<c:choose>
			...
			<c:otherwise>
				<a href="rest/qmp/searchYoukong?pageNow=${page.totalPageCount}"
					class='search_A'>尾页</a>
			</c:otherwise>
		</c:choose>
		<script>
