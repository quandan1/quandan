...
<head>
    ...
    <script type="text/javascript" src='app/js/qmp/qmpTestData.js'></script>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">添加实测数据</h4>
            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">修改实测数据</h4>
            </div>
            <div class="modal-body">
                <div id="editDiv"></div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">实测数据查询</h4>
            </div>
            <div class="modal-body">
                <div id="searchDiv">
                </div>
