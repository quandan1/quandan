...
<body>
	<div id="list" style="display: block">
		<table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic" id="searchSelectTable">
			<tr>
				<button type="button" class="btnz btnz-info" id="addSearch">添加条件</button>
				<button type="button" class="btnz btnz-info" id="removeSearch">删除条件</button>
			</tr>
			<tr>
				<td>
					<div class="dropdown">
	...
	<script type="text/javascript" src="app/js/qmp/searchQmpSzxz.js"></script>
