...
<body>
	<div id="list" style="display: block">
		<table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic" id="searchSelectTable">
			...
			<tr>
				<td>
					<div class="dropdown">
						<button class="btnz btnz-info" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
	...
	<script type="text/javascript" src="app/js/pollsource/searchPollSource.js"></script>
</body>
</html>