...
<body>
		<select name="sy" id="sy" title="指标分析" style="margin-right: 5px;width: 138px;text-align: center" onchange="water()">
...
<script type="text/javascript" src="app/js/qmp/watershed.js"></script>
</body>
</html>