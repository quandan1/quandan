...
<div id="list" style="display: block;overflow:auto;width:100%;">
    <table width="100%" border="0" cellpadding="7" cellspacing="0"
        ...
        <tr>
            ...
            <th align="center" style="white-space: nowrap;text-align: center;background:#99A4AF;color:white">包括水系</th>
            <th align="center" style="white-space: nowrap;text-align: center;background:#99A4AF;color:white">所含干流</th>
            <th align="center" style="white-space: nowrap;text-align: center;background:#99A4AF;color:white">所含一级支流</th>
            <th align="center" style="white-space: nowrap;text-align: center;background:#99A4AF;color:white">所含二级支流</th>
            <th align="center" style="white-space: nowrap;text-align: center;background:#99A4AF;color:white">所含三级支流</th>
            <th align="center" style="white-space: nowrap;text-align: center;background:#99A4AF;color:white">所含四级支流</th>
        ...
        <c:forEach var="kzdyJbxx" items="${klist}">
            <tr >
...
<div align="center" id="page">
    ...
    ${page.pageNow} 页</font> <a href="rest/kzdy/list?pageNow=1">首页</a>
    <c:choose>
        <c:when test="${page.pageNow - 1 > 0}">
            <a href="rest/kzdy/list?pageNow=${page.pageNow - 1}">上一页</a>
        </c:when>
        <c:when test="${page.pageNow - 1 <= 0}">
    ...
    <c:choose>
        <c:when test="${page.totalPageCount==0}">
            <a href="rest/kzdy/list?pageNow=${page.pageNow}">下一页</a>
        </c:when>
        <c:when test="${page.pageNow + 1 <= page.totalPageCount}">
            <a href="rest/kzdy/list?pageNow=${page.pageNow + 1}">下一页</a>
        </c:when>
        <c:when test="${page.pageNow + 1 > page.totalPageCount}">
    ...
    <c:choose>
        <c:when test="${page.totalPageCount==0}">
            <a href="rest/kzdy/list?pageNow=${page.pageNow}">尾页</a>
        </c:when>
        <c:otherwise>
            <a href="rest/kzdy/list?pageNow=${page.totalPageCount}">尾页</a>
        </c:otherwise>
    </c:choose>
</div>
<!-- 分页功能 end -->
