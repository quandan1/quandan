...
<input type="text" value="${role_sign}"/>

	<div class="mainBox"
						style="height: auto !important; height: 550px; min-height: 550px;">
						<h3>添加${role_name}市政策法规</h3>
	<form id="insertForm">
		<table width="100%" border="0" cellpadding="8" cellspacing="0"
			class="tableBasic">
			<tr>
				<td width="90" align="right">名称</td>
				<td><input type="text" size="60" class="inpMain"  name="title" id="title-zcfggjj" /></td>
			</tr>
            <tr>
			...
			<tr>
				...
				<td> 
				 <select name="type" id="type" style="width:255px;">
                      ...
                      <option value="${role_name}市">${role_name}市</option>
                 </select>
               </td>
			</tr>
			<tr>
