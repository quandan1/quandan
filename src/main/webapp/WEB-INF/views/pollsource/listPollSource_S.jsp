...
<body>
	...
	<div align="center" id="searchPage">
		...
		<a href="rest/psrc/search?pageNow=1" class='search_A'>首页</a>
		<c:choose>
			<c:when test="${page.pageNow - 1 > 0}">
				<a href="rest/psrc/search?pageNow=${page.pageNow - 1}"
					class='search_A'>上一页</a>
			</c:when>
			<c:when test="${page.pageNow - 1 <= 0}">
				<!-- <a href="rest/psrc/search?pageNow=1" class='search_A'>上一页</a> -->
			</c:when>
		</c:choose>
		<c:choose>
			<c:when test="${page.totalPageCount==0}">
				<a href="rest/psrc/search?pageNow=${page.pageNow}"
			...
			<c:when test="${page.pageNow + 1 > page.totalPageCount}">
				<%-- <a href="rest/psrc/search?pageNow=${page.totalPageCount}"
					class='search_A'>下一页</a> --%>
			</c:when>
		</c:choose>
		<c:choose>
