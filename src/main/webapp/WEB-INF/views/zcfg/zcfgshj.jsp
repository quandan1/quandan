...
<script src="app/js/fileinput_locale_zh.js" type="text/javascript"></script>
	...
	<script>
        $('#inst').toggle();
//        var type =encodeURI($("#hasGetRoleName").val()) ;
//        var role_sign = encodeURI($("#hasGetRoleSign").val());
	...
	<div id="all">
	       <div id="left" style="width:100%;" >
	 				<div class="form-group" >  
						<c:if test="${ role_sign != 'admin' and role_sign != '1' }">
							<div>
						...
						<script type="text/javascript">
                            $(document).ready(function() {
                                ...
                                $('#addButton').click(function(){
                                    var rolename = $("#hasGetRoleName").val();
                                    var url = "rest/page/addZcfgShj?rolename="+rolename;
                                    $.get(url, function(data) {
                                        $('#addDiv').html(data);
                                    });
                                });
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">添加市级政策法规</h4>
				</div>
