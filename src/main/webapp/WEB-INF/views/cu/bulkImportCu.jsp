    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0"
        ...
        <tr>
            ...
            <td width="15%" align="center">
                <a type="button" class="btnz btnz-info" id="download" href="download/cu/控制单元模板.xls"  readonly=""><i class='glyphicon glyphicon-download'></i>下载</a>
            </td>
...
<script type="text/javascript" src="app/js/cu/bulkImportCu.js"></script>
