...
<div id="list" style="display: block;overflow:auto;width:100%;">
    ...
    <table width="100%" border="0" cellpadding="7" cellspacing="0"
        ...
        <div align="center" id="page">
            ...
            ${page.pageNow} 页</font> <a href="rest/kzdm/search?pageNow=1">首页</a>
            <c:choose>
                <c:when test="${page.pageNow - 1 > 0}">
                    <a href="rest/kzdm/search?pageNow=${page.pageNow - 1}">上一页</a>
                </c:when>
                <c:when test="${page.pageNow - 1 <= 0}">
            ...
            <c:choose>
                <c:when test="${page.totalPageCount==0}">
                    <a href="rest/kzdm/search?pageNow=${page.pageNow}">下一页</a>
                </c:when>
                <c:when test="${page.pageNow + 1 <= page.totalPageCount}">
                    <a href="rest/kzdm/search?pageNow=${page.pageNow + 1}">下一页</a>
                </c:when>
                <c:when test="${page.pageNow + 1 > page.totalPageCount}">
            ...
            <c:choose>
                <c:when test="${page.totalPageCount==0}">
                    <a href="rest/kzdm/search?pageNow=${page.pageNow}">尾页</a>
                </c:when>
                <c:otherwise>
                    <a href="rest/kzdm/search?pageNow=${page.totalPageCount}">尾页</a>
                </c:otherwise>
            </c:choose>
    <script>
