	...
	<!-- 分页功能 start -->
		<div align="center" id="searchPage">
						<font size="2">共 ${page.totalPageCount} 页</font> <font size="2">第
							${page.pageNow} 页</font> <a href="rest/controlunit/searchYoukong?pageNow=1"
							class='search_A'>首页</a>
						<c:choose>
							<c:when test="${page.pageNow - 1 > 0}">
								<a href="rest/controlunit/searchYoukong?pageNow=${page.pageNow - 1}"
						...
						<c:choose>
							<c:when test="${page.totalPageCount==0}">
								<a href="rest/controlunit/searchYoukong?pageNow=${page.pageNow}"
						...
						<c:choose>
							...
							<c:otherwise>
								<a href="rest/controlunit/searchYoukong?pageNow=${page.totalPageCount}"
									class='search_A'>尾页</a>
							</c:otherwise>
						</c:choose>
						<script>
